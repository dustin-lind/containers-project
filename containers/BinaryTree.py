...
class BinaryTree():
    ...
    def to_list(self, traversal_type):
        ...
        results if needed.
        Many of the test cases for more complicated tree functions rely on this
        to_list function,
    ...
    @staticmethod
    def __len__helper(node, len_sum=0):
        '''
        FIXME:
        ...
        try:
            len_sum += 1
            if node.left:
                len_sum += BinaryTree.__len__helper(node.left)
            if node.right:
                len_sum += BinaryTree.__len__helper(node.right)
            return len_sum
        except Exception:
            return 0
    ...
    @staticmethod
    def _height(node, left_height=0, right_height=0):
        '''
        FIXME:
        Implement this function.
        '''
